...
class TransfersTest < ApplicationSystemTestCase
  ...
  test "should create transfer" do
    ...
    fill_in "From user", with: @transfer.from_user_id
    fill_in "Memo", with: @transfer.memo
    fill_in "To user", with: @transfer.to_user_id
    fill_in "Token", with: @transfer.token_id
